...
from tec.ic.ia.p2.g08_query import get_commands

from tec.ic.ia.p2 import g08_logic_w_w
from tec.ic.ia.p2 import g08_logic_i_w
from tec.ic.ia.p2 import g08_logic_i_i
...
class TestQuery(object):
    ...
    def test_command_stack_w_w_1(self):
        ...
        command_stack, _, _ = get_commands(inputs, g08_logic_w_w)
    ...
    def test_command_stack_w_w_2(self):
        ...
        _, functions, _ = get_commands(inputs, g08_logic_w_w)
    ...
    def test_command_stack_w_w_3(self):
        ...
        _, _, outputs = get_commands(inputs, g08_logic_w_w)
    ...
    def test_command_stack_i_w_1(self):
        ...
        command_stack, _, _ = get_commands(inputs, g08_logic_i_w)
        assert expected_command_stack == command_stack
    ...
    def test_command_stack_i_w_2(self):
        ...
        _, functions, _ = get_commands(inputs, g08_logic_i_w)
    ...
    def test_command_stack_i_w_3(self):
        ...
        _, _, outputs = get_commands(inputs, g08_logic_i_w)
        assert expected_outputs == outputs
    ...
    def test_command_stack_i_i_1(self):
        ...
        command_stack, _, _ = get_commands(inputs, g08_logic_i_i)
        assert expected_command_stack == command_stack
    ...
    def test_command_stack_i_i_2(self):
        ...
        _, functions, _ = get_commands(inputs, g08_logic_i_i)
    ...
    def test_command_stack_i_i_3(self):
        ...
        _, _, outputs = get_commands(inputs, g08_logic_i_i)
        assert expected_outputs == outputs
